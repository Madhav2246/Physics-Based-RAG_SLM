...
DUMP_JSONL   = ROOT / "data" / "evaluation_new" / "stage1_new_separate_eval" / "answers_dump.jsonl"
OUT_JSON     = ROOT / "data" / "evaluation_new" / "stage6_significance.json"
OUT_MD       = ROOT.parent / "final_report" / "evaluation_stages" / "stage6_significance.md"
OUT_PNG      = ROOT.parent / "final_report" / "evaluation_stages" / "stage6_significance.png"
...
CSYS  = "#1D4ED8"; CGOOD = "#047857"; CBAD  = "#B91C1C"
CNEU  = "#D97706"; CRAW  = "#64748B"; CPURP = "#701A75"
