...
Saves results to:
- backend_new/data/evaluation/eval_compare_more_models.jsonl (Raw data)
- backend_new/data/evaluation/eval_compare_more_models_summary.json (JSON summary)
- backend_new/data/evaluation/eval_compare_more_models_table.tex (LaTeX table)
- backend_new/data/evaluation/eval_compare_more_models_report.md (Markdown report)
"""
