...
class ValueTracker:
    ...
    DEFAULTS: Dict[str, TrackedValue] = {
        ...
        "WL":    TrackedValue("WL",    10.0,    "-",       "default", "aspect ratio W/L (100nm: 1µm/100nm)"),
        "eps":   TrackedValue("eps",   3.45e-11,"F/m",     "default", "oxide permittivity (SiO2)"),
        "eps_ox":TrackedValue("eps_ox",3.45e-11,"F/m",     "default", "SiO2 permittivity"),
    }
