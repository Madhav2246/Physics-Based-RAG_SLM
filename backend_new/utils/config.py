...
# Embedder for dense retrieval. SOTA sweep (2026-06-07) winner: bge-large-en-v1.5
# @ chunk 384/64 → Hit@3 0.65 (vs MiniLM@512 baseline 0.52). bge-large needs a
# query-side instruction prefix and cosine (normalized) similarity. To revert to
# the old MiniLM index, set EMBED_MODEL_NAME="all-MiniLM-L6-v2", EMBED_DIM=384,
# QUERY_PREFIX="", NORMALIZE_EMBEDDINGS=False.
EMBED_MODEL_NAME     = "BAAI/bge-large-en-v1.5"
EMBED_DIM            = 1024
QUERY_PREFIX         = "Represent this sentence for searching relevant passages: "
DOC_PREFIX           = ""
NORMALIZE_EMBEDDINGS = True   # cosine via normalized vectors + IndexFlatIP
