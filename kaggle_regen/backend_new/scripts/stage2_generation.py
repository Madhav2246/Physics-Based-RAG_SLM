...
# Stage 1 writes the dump into stage1_new_separate_eval/. run_all.py promotes it
# up to data/evaluation/, but fall back to the subfolder so standalone runs work.
if not DUMP.exists():
